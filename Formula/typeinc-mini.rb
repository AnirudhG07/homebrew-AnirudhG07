class Typeinc_mini < Formula
    desc "Typeinc-mini, a miniature version of Typeinc, is a cool ncurses based Typing Speed Test tool where you can enjoy typing experience in Terminal with different difficulty levels."
